    ...
    <div class="box-header flex-justify-center">
      <div class="col-lg-8 col-sm-12">
        <div class="innerContainer">
          <h4 class="subTitleB"><i class="fa fa-plus-circle"></i> Complete los campos para agregar un nuevo perfil</h4>
          <form method="post">
                ...
                <div class="lineContainer txC">
                  ...
                  <div class="flex-allCenter imgSelector">
                    <div class="imgSelectorInner">
                      <img src="../../../skin/images/body/pictures/profilegen.jpg" class="img-responsive MainImg animated">
