      ...
      <?php echo insertElement("hidden","action",'insert'); ?>
        ...
        <div class="container animated fadeInUp donediv">
             <div class="form-group">
               <a href="#" class="btn masterbtn" role="button" id="create"><i class="fa fa-check-square-o fa-fw"></i> Crear Categoría</a>
               <a href="#" class="btn masterbtn" role="button" id="create"><i class="fa fa-check-square-o fa-fw"></i> Crear y Agregar Otra</a>
             </div>
        </div>
        <!-- /Create User Button Div  -->                   
  </div>
