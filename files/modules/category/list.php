...
<body>
    ...
    <div id="wrapper"><!--  Wrapper -->
        <div class="container-fluid">
            <div class="maintitle"><h4 class="maintitletxt">Listado de Categorías de Productos</h4></div>
                <div class="glasscontainer1 optionsdiv"> 
                    ...
                    <a href="new.php"><button class="masterbtn"><i class="fa fa-user-plus"></i> Agregar Categoría</button></a>    
                </div>
            ...
            <div id="viewlist" class="row">
                ...
                <div id="emptylist" class="container-fluid glasscontainer1 listrow" style="text-align:center;display:block;"><p>No existen categorías, puede crear una haciendo click&nbsp;<a href="new.php">aqui</a></p></div>
                <?php }?>
                <?php 
                ...
                ?>
                <!-- Items -->
                <div id="list<?php echo $Category->ID ?>" class="container-fluid glasscontainer1 listrow">
