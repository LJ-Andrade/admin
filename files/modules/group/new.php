    ...
    <div class="box-header flex-justify-center">
      <div class="col-lg-8 col-sm-12">
        <div class="innerContainer">
          <h4 class="subTitleB"><i class="fa fa-plus-circle"></i> Rellene los campos para agregar un nuevo grupo</h4>
          <form method="post">
            ...
            <div class="row form-group inline-form-custom-2">
              ...
              <div class="col-xs-6 inner">
                <input type="name" class="form-control" placeholder="Nombre del grupo">
              </div>
