            ...
            <div class="row form-group inline-form-custom-2">
              ...
              <div class="col-xs-12 col-sm-6 inner">
                ...
                <div class="form-group" id="groups-wrapper">
                  <?php echo insertElement('multiple','profile','','form-control select2 selectProfileTags','data-placeholder="Seleccione Perfiles" style="width: 100%;"',$DB->fetchAssoc('admin_profile','profile_id,title',"status<>'I' AND profile_id >= ".$_SESSION['profile_id']." AND customer_id = ".$_SESSION['customer_id'])); ?>
                </div>
              </div>
